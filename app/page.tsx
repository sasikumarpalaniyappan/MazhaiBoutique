...
export default function Home() {
  return (
    <main className="scroll-smooth">
      {/* HOME SECTION */}
      <section id="home" className="relative w-full h-screen sm:h-screen flex items-center justify-center mt-0 overflow-hidden">
        <HeroCarousel />
        ...
        <div className="relative text-center text-white px-4 sm:px-6 z-10">
          ...
          <div className="flex items-center justify-center">
            <a href="#featured" className="inline-block bg-pink-600 hover:bg-pink-700 text-white font-bold px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base lg:text-lg cursor-pointer transition-colors">
              Explore Collection
            </a>
          </div>
        </div>
      ...
      <section id="about" className="bg-gray-50 py-12 sm:py-20 scroll-mt-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-pink-600 mb-8 sm:mb-12" style={{ fontFamily: 'Cormorant, serif', fontStyle: 'italic' }}>
            About Mazhai Boutique
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 mb-8 sm:mb-12">
            <div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-pink-600 mb-4" style={{ fontFamily: 'Cormorant, serif', fontStyle: 'italic' }}>Our Story</h3>
            ...
            <div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-pink-600 mb-4" style={{ fontFamily: 'Cormorant, serif', fontStyle: 'italic' }}>Our Mission</h3>
              <p className="text-gray-700 text-sm sm:text-base md:text-lg leading-relaxed mb-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-pink-600 mb-6 sm:mb-8 text-center" style={{ fontFamily: 'Cormorant, serif', fontStyle: 'italic' }}>Why Choose Mazhai Boutique?</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="text-center">
                <h4 className="text-base sm:text-lg md:text-xl font-bold text-pink-600 mb-3" style={{ fontFamily: 'Cormorant, serif', fontStyle: 'italic' }}>Premium Quality</h4>
                <p className="text-gray-700 text-sm sm:text-base">
                  We offer only the finest fabrics and handcrafted pieces that stand the test of time.
                </p>
              </div>
              <div className="text-center">
                <h4 className="text-base sm:text-lg md:text-xl font-bold text-pink-600 mb-3" style={{ fontFamily: 'Cormorant, serif', fontStyle: 'italic' }}>Authentic Designs</h4>
                <p className="text-gray-700 text-sm sm:text-base">
                  Each collection celebrates traditional craftsmanship with modern sensibility.
                </p>
              </div>
              <div className="text-center">
                <h4 className="text-base sm:text-lg md:text-xl font-bold text-pink-600 mb-3" style={{ fontFamily: 'Cormorant, serif', fontStyle: 'italic' }}>Customer Care</h4>
                <p className="text-gray-700 text-sm sm:text-base">
